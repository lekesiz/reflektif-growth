...
| `pnpm cli reenrich <companyId...>` | Belirli kurumları yeniden sınıfla (bayat enrich-job'ı sil → taze enqueue → yalnız `leadgen:enrich` turu; kaynak taraması YOK, compintel'e dokunmaz) |
